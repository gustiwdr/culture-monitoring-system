...
<div class="container mx-auto p-6 pl-64">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md mt-6">
        ...
        <p><strong>Deskripsi:</strong> {{ $report->summary }}</p>
        ...
        <a href="{{ route('division.reports.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded mt-6 inline-block">Kembali ke Daftar Laporan</a>
    </div>
</div>
@endsection
